        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('assignments.create') }}" :active="request()->routeIs('assignments.create')">
                    ...
                    <x-jet-nav-link href="{{ route('assignments.submit') }}" :active="request()->routeIs('assignments.submit')">
